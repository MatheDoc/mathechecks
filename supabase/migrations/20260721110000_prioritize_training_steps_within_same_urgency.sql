-- Bei gleicher Dringlichkeitsklasse zuerst die niedrigere Check-Schritttiefe.
-- So werden bei hohem Zeitdruck zunächst die Trainings aller offenen Checks
-- geführt; zeitlich dringendere bzw. überfällige Folgeaktivitäten bleiben
-- durch urgency_rank weiterhin vorrangig.

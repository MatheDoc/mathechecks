-- byType in get_user_activity_overview() um den neuen Aktivitaetstyp 'test' ergaenzen.
-- Basis: 20260701160000_restore_activity_map_in_activity_overview.sql (activityMap bleibt erhalten).
...
begin
    ...
    select jsonb_build_object(
        ...
        'byType', jsonb_build_object(
            ...
            'test', coalesce((select activity_count from counts_by_type where activity_type = 'test'), 0),

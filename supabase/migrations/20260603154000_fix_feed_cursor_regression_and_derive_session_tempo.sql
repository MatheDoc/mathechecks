-- Restores the latest runtime-safe cursor implementation after the priority-class
-- migration and derives session tempo from remaining workload plus target date.
...
begin
    ...
    effective_tempo_days := case
        ...
        else public.derive_learning_session_tempo_days(active_session_id, normalized_target_date, default_tempo_days)
    end;

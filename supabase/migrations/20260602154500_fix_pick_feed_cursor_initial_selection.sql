-- Fix: Beim ersten Feed-Read einer neuen Session ist noch kein Cursor gesetzt.
-- `pick_feed_cursor` darf in diesem Fall nicht auf das uninitialisierte
-- `current_item`-Record zugreifen.

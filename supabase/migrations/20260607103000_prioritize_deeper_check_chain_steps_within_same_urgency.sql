-- Priorisiert innerhalb derselben Dringlichkeitsklasse die tiefere Check-Kette
-- vor der früheren Zeitmarke. Damit gewinnen bei Gleichstand z. B. Recall,
-- Feynman oder Kompetenzliste-Gate vor später angesetzten Trainingsschritten.

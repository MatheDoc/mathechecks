...
class AblehnungsbereichRechtsseitigOhneStrukturGenerator(TaskGenerator):
    generator_key = "stochastik.hypothesentests.ablehnungsbereich_rechtsseitig_ohne_struktur"
    ...
    def generate(self, count: int, seed: int | None = None) -> list[Task]:
        ...
        for _ in range(count):
            ...
            answer = (
                ...
                f"[ {numerical(k, tolerance=0, decimals=0)}, \u2026 , {numerical(n, tolerance=0, decimals=0)} ]."
            )

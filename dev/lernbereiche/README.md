...
| **Skript** | Mathematische Inhalte | Einführen, Verstehen, Nachschlagen, Beispiele mit Fading | Zu jeder Aufgabe aus dem Training gibt es im Skript eine Hilfestellung (aktuell über `include info`) |
